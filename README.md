...
Для каждого приложения создаем пользователя «user» в системе и домашнюю папку /home/user. В домашней папке делаем папку для проекта /home/user/mysite.ru. В папку проекта клонируем репозиторий:
...
* [/app/sql](/app/sql) — sql-файлики со структурой БД.
